        ...
        <section id="TouristPalces" class="container my-5">
            ...
            <div class="weathersahar">
                <h4 class="text-center my-4"><a
                        href="https://www.msn.com/ar-sa/weather/forecast/in-%D9%85%D8%AD%D8%A7%D9%81%D8%B8%D8%A9-%D8%B4%D9%85%D8%A7%D9%84-%D8%A7%D9%84%D8%A8%D8%A7%D8%B7%D9%86%D8%A9,%D8%B9%D9%85%D8%A7%D9%86?loc=eyJyIjoi2YXYrdin2YHYuNipINi02YXYp9mEINin2YTYqNin2LfZhtipIiwiYyI6Iti52YXYp9mGIiwiaSI6Ik9NIiwiZyI6Im
                FyLXNhIiwieCI6IjU2Ljc0MiIsInkiOiIyNC4zNDUifQ%3D%3D&ocid=ansmsnweather&weadegreetype=C"
                        data-translate="saharweather"><span class="d-inline-block">Sahar Weather</span></a></h4>
            </div>
            <div class="cards row">
                <div class="card col-12 col-sm-6 col-md-4 my-4">
                    <img src="{{ asset('assets/images/img1.AVIF') }}" class="card-img-top" alt="img1">
                    <div class="card-body">
                        <h3 class="card-title" data-translate="loc1">sahar castle</h3>
                        <p class="card-text fs-5" data-translate="title1">This castle is one of the oldest tourist places
                            in Sohar, and one of the most important castles and forts due to its privileged location, and
                            the important role it played over the past
                            centuries</p>
                    </div>
                </div>
                <div class="cards col-12 col-sm-6 col-md-4 my-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title" data-translate="loc2">Sultan Qaboos Mosque</h3>
                            <p class="card-text fs-5" data-translate="title2">One of the most beautiful tourist places in
                                the state of Sohar, is a huge, newly built royal mosque. If you are visiting Sohar,
                                this landmark is one of the most important architectural features that you can see
                            </p>
                        </div>
                    </div>
                </div>
                <div class="cards col-12 col-sm-6 col-md-4 my-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title" data-translate="loc3">Sohar Old Market</h3>
                ...
                <div class="cards col-12 col-sm-6 col-md-4 my-4">
                    <div class="card">
                        <img src="{{ asset('assets/images/img4.AVIF') }}" class="card-img-top" alt="img4">
                        <div class="card-body">
                            <h3 class="card-title" data-translate="loc4">Sohar Corniche</h3>
                            <p class="card-text fs-5" data-translate="title4">It is one of the most beautiful tourist
                                attractions in Sohar, one of the most crowded places, whether with residents or visitors to
                                the city, so you can enjoy the wonderful waterfront
                                with breezes of clean, fresh air </p>
                        </div>
                    </div>
                </div>
                <div class="cards col-12 col-sm-6 col-md-4 my-4">
                    <div class="card">
                        <img src="{{ asset('assets/images/img5.AVIF') }}" class="card-img-top" alt="img5">
                        <div class="card-body">
                            <h3 class="card-title" data-translate="loc5">Silver Jubilee Park</h3>
                            <p class="card-text fs-5" data-translate="title5">One of the most wonderful tourist
                                attractions in Sohar, and it was established on the occasion of the silver jubilee of the
                                renaissance that the Sultanate is witnessing,
                                which is characterized by a wonderful design</p>
                        </div>
                    </div>
                </div>
                <div class="cards col-12 col-sm-6 col-md-4 my-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h3 class="card-title" data-translate="loc6">Sohar Gardens</h3>
            ...
            <div class="cards row my-5 py-5">
                <div class="card rv-item col-12 col-sm-6 col-md-4 my-2 mx-auto p-3">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur
                        adipisicing elit. Corporis dolor dicta cum. Eos beatae eligendi, magni numquam nemo sed ut corrupti,
